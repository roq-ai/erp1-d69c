...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'organization.update': {
    roles: ['owner', 'team-member', 'analyst', 'security-officer'],
  ...
  'business_application.create': {
    ...
    key: 'new-business-app',
    tenantPath: ['organization', 'business_application'],
    userPath: [],
  },
  'security_analysis.update': {
    roles: ['owner', 'security-officer'],
    key: 'security-analysis-updated',
    tenantPath: ['organization', 'security_analysis'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'team-member', 'analyst', 'security-officer'];
