...
export const getBusinessApplications = async (
  query?: BusinessApplicationGetQueryInterface,
): Promise<PaginatedInterface<BusinessApplicationInterface>> => {
  const response = await axios.get('/api/business-applications', {
    params: query,
