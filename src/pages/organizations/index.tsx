  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: [
          'user',
          'business_application.count',
          'landscape_analysis.count',
          'log_analysis.count',
          'security_analysis.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('business_application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'business_application',
          cell: ({ row: { original: record } }: any) => record?._count?.business_application,
        }
      : null,
    hasAccess('landscape_analysis', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'landscape_analysis',
          header: 'Landscape Analysis',
          accessorKey: 'landscape_analysis',
          cell: ({ row: { original: record } }: any) => record?._count?.landscape_analysis,
        }
      : null,
    hasAccess('log_analysis', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('security_analysis', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'security_analysis',
          header: 'Security Analysis',
          accessorKey: 'security_analysis',
          cell: ({ row: { original: record } }: any) => record?._count?.security_analysis,
        }
      : null,
