...
import { getLandscapeAnalysisById } from 'apiSdk/landscape-analyses';
import { LandscapeAnalysisInterface } from 'interfaces/landscape-analysis';

function LandscapeAnalysisViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Landscape Analysis Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Landscape Analysis Details
                  </Text>
                </Box>
                {hasAccess('landscape_analysis', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/landscape-analyses/edit/${id}`} passHref legacyBehavior>
                    <Button
