...
import { getSecurityAnalysisById } from 'apiSdk/security-analyses';
import { SecurityAnalysisInterface } from 'interfaces/security-analysis';

function SecurityAnalysisViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Security Analysis Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('security_analysis', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/security-analyses/edit/${id}`} passHref legacyBehavior>
                    <Button
